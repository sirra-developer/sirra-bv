...
function ContactLink({
  ...
  return (
    <a
      className="text-sirra-green inline-flex items-center gap-3 underline-offset-4 hover:underline"
      href={href}
      ...
      {employees.map((employee) => (
        <li key={employee._id}>
          <article className="h-full">
            ...
            {employee.phoneNumber || employee.email || employee.linkedinUrl ? (
              <div className="mt-6 flex flex-col items-start gap-3 text-sm font-semibold sm:flex-row sm:flex-wrap sm:gap-x-7">
                {employee.phoneNumber ? (
                  <ContactLink
                    href={phoneHref(employee.phoneNumber)}
                    icon={<PhoneIcon />}
                  >
                    {employee.phoneNumber}
                  </ContactLink>
